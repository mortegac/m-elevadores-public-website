...
const createDefaultSerializer = (args) => wrapMapSerializer({
  ...
  image: ({ node, key }) => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { className: "block-img", children: node.linkTo ? /* @__PURE__ */ (0,jsx_runtime.jsx)(PrismicLink/* PrismicLink */.w, { linkResolver: args.linkResolver, internalComponent: args.internalLinkComponent, externalComponent: args.externalLinkComponent, field: node.linkTo, children: img }) : img }, key);
  },
  ...
  hyperlink: ({ node, children, key }) => /* @__PURE__ */ (0,jsx_runtime.jsx)(PrismicLink/* PrismicLink */.w, { field: node.data, linkResolver: args.linkResolver, internalComponent: args.internalLinkComponent, externalComponent: args.externalLinkComponent, children }, key),
...
// EXTERNAL MODULE: ./node_modules/@prismicio/react/dist/usePrismicContext.js
var usePrismicContext = __webpack_require__(8409);
...
const PrismicRichText_PrismicRichText = function PrismicRichText2({ components, ...restProps }) {
  const context = (0,usePrismicContext/* usePrismicContext */.i)();
...
function SliceZone({ slices = [], components = {}, resolver, defaultComponent, context = {} }) {
  ...
  const renderedSlices = slices.map((slice, index) => {
    ...
    if (Comp) {
      ...
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(TODOSliceComponent, { slice }, key);
    }
  });
